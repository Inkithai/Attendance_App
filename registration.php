        ...
        <div>
          <form action="queries/registration_form.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" class="form-control" name="user_contact" placeholder="+941234567" required>
            </div>
            <div class="mb-4">
            ...
            <div class="mt-4">
                <div class='text-center'>
                    <button type="submit" name="register" class="btn btn-custom fw-bold w-25">REGISTER</button>
                </div>
            </div>
          </form>
        </div>
